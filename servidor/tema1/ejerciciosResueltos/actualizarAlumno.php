...
function ActualizarArchivo($linea, $alumnos) {
  ...
  function MostrarForm($lineaAlu)
  {
    ...
    echo "NIF<input type='text' name='NIF' value='$campos[0]' readonly><br>  ";
  ...
  if (isset($_GET['Actualizar'])) {
    //recoger del formulario de ese alumno
    $nif = $_GET['NIF'];
    $nombre = $_GET['Nombre'];
    ...
    ActualizarArchivo($linea, $alumnos); //funcion que actualiza los valores en el archivo
  ...
  <fieldset>
    <legend>Seleccione un alumno para mostrar su ficha</legend>
