...
public function listarOrdenado($campo, $orden)       //Lista los productos ordenados por un campo específico
{
    $consulta = "SELECT * FROM producto ORDER BY $campo $orden";
    
    $this->productos = array();  // Vaciamos el array de las situaciones entre consulta y consulta
    
    $this->ConsultaDatos($consulta, array());
