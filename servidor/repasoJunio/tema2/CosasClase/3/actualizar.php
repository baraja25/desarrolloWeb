...
if (isset($_POST['seleccionar'])) {
    ...
    $cocheDetalle = $db->query($consulta, [$matriculaSeleccionada])->fetch(PDO::FETCH_ASSOC);
    $bandera = true;
    ...
    $consultaActualizar = "UPDATE coche SET nombre = ?, marca = ?, modelo = ?, precio = ?, matricula = ?, anio = ?, foto = ? WHERE matricula = ?";
    $db->query($consultaActualizar, [$nombre, $marca, $modelo, $precio, $matriculaEdit, $anio, $foto, $matriculaSeleccionada]);
